...
export interface JuliaInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "allowance"
      | "approve"
...
export interface Julia extends BaseContract {
  connect(runner?: ContractRunner | null): Julia;
  ...
  getBalance: TypedContractMethod<[_from: AddressLike], [bigint], "view">;
  ...
  ): TypedContractMethod<[_from: AddressLike], [bigint], "view">;
  getFunction(
